...
public class Level2_3 {
    ...
    public Level2_3(int state) throws Exception {
        ...
        //addBlock
        {
            ...
            for (int i = 660; i <= 1000; i += 30) {
                SurfaceBlock surfaceBlock = new SurfaceBlock(30, 30, i, -90);
                pane.getChildren().add(surfaceBlock);
                blocks.add(surfaceBlock);
            }
            for (int i = -600; i <= -120; i += 30) {
                SurfaceBlock surfaceBlock = new SurfaceBlock(30, 30, 710, i);
                pane.getChildren().add(surfaceBlock);
                blocks.add(surfaceBlock);
            }
