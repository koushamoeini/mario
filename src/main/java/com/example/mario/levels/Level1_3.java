...
public class Level1_3 {
    ...
    public Level1_3(int state) throws Exception {
        ...
        //addBackGround
        {
            ...
            images.add(hill1);
            BackGround eye1 = new BackGround(60, 60, 2700, 310, new Image(getClass().getResource("/Images/backGrounds/white.png").toExternalForm()));
            pane.getChildren().add(eye1);
            images.add(eye1);
            BackGround eye2 = new BackGround(100, 100, 2460, 320, new Image(getClass().getResource("/Images/backGrounds/white.png").toExternalForm()));
            pane.getChildren().add(eye2);
            images.add(eye2);
            BackGround castle = new BackGround(400, 400, 2390, 200, new Image(getClass().getResource("/Images/backGrounds/castle.png").toExternalForm()));
        ...
        stage.show();
        @SuppressWarnings("unused") MotionHandler motionHandler = new MotionHandler(blocks, enemies, images, items, stage, pane, 3,state);
    }
