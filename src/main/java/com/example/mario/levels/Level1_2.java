...
public class Level1_2 {
    ...
    public Level1_2() throws IOException {
        ...
        while (true) {
            ...
            Block pipe = new Block(Block.Type.Pipe, 90, 150, 500, 90,stage,pane,coins);
            ...
            Block mystery = new Block(Block.Type.Mystery, 30, 30, 240, 370,stage,pane,coins);
            pane.getChildren().add(mystery);
            blocks.add(mystery);
            /////////////////////////////////////////////////
            for (int i = 1800; i <= 1980; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, i, 360,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 1890; i <= 1980; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, i, 270,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 270; i <= 360; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, 1800, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 360; i <= 450; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, 1980, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 1770; i <= 1890; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, i, 450,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 300; i <= 450; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, 1890, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            /////////////////////////////////////////
            for (int i = 2160; i <= 2340; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, i, 300,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 2250; i <= 2340; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, i, 210,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 210; i <= 300; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, 2160, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            for (int i = 300; i <= 390; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, 2340, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            ...
            for (int i = 240; i <= 390; i += 30) {
                Block brick = new Block(Block.Type.Brick, 30, 30, 2250, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            /////////////////////////////////////////
            for (int i = 240; i <= 450; i += 30) {
                Block brick = new Block(Block.Type.Stair, 30, 30, 2430, i,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
        ...
        while (true) {
            ...
            for (int i = 660; i <= 3690; i += 30) {
                Block brick = new Block(Block.Type.Surface, 30, 30, i, -100,stage,pane,coins);
                pane.getChildren().add(brick);
                blocks.add(brick);
            }
            Block win=new Block(Block.Type.WinBlock,60,150,4020,330,stage,pane,coins);
