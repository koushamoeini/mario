...
public class Level2_2 {
    ...
    public Level2_2(int state) throws Exception {
        ...
        //addBackGround
        {
            BackGround backGround = new BackGround(1020, 600, 0, 0, new Image(getClass().getResource("/Images/backGrounds/mahan.png").toExternalForm()));
            ...
            images.add(cloud6);
            BackGround cloud7 = new BackGround(150, 70, 2200, 150, new Image(getClass().getResource("/Images/backGrounds/cloud2.png").toExternalForm()));
            pane.getChildren().add(cloud7);
            images.add(cloud7);
            BackGround cloud8 = new BackGround(170, 80, 2530, 40, new Image(getClass().getResource("/Images/backGrounds/cloud2.png").toExternalForm()));
            pane.getChildren().add(cloud8);
            images.add(cloud8);
            BackGround cloud9 = new BackGround(160, 70, 2950, -30, new Image(getClass().getResource("/Images/backGrounds/cloud1.png").toExternalForm()));
            pane.getChildren().add(cloud9);
            images.add(cloud9);
            BackGround cloud10 = new BackGround(160, 80, 3320, 120, new Image(getClass().getResource("/Images/backGrounds/cloud3.png").toExternalForm()));
            pane.getChildren().add(cloud10);
            images.add(cloud10);
            BackGround cloud11 = new BackGround(170, 80, 3690, 90, new Image(getClass().getResource("/Images/backGrounds/cloud1.png").toExternalForm()));
            pane.getChildren().add(cloud11);
            images.add(cloud11);
            BackGround cloud12 = new BackGround(160, 70, 3940, -40, new Image(getClass().getResource("/Images/backGrounds/cloud2.png").toExternalForm()));
            pane.getChildren().add(cloud12);
            images.add(cloud12);
            BackGround cloud13 = new BackGround(160, 70, 4040, 140, new Image(getClass().getResource("/Images/backGrounds/cloud3.png").toExternalForm()));
            pane.getChildren().add(cloud13);
            images.add(cloud13);
            BackGround cloud14 = new BackGround(150, 70, 4530, 80, new Image(getClass().getResource("/Images/backGrounds/cloud2.png").toExternalForm()));
            ...
            images.add(bush2);
            BackGround hill2 = new BackGround(400, 200, 3060, 410, new Image(getClass().getResource("/Images/backGrounds/hill1.png").toExternalForm()));
            pane.getChildren().add(hill2);
            images.add(hill2);
            BackGround eye1 = new BackGround(60, 60, 4210, 310, new Image(getClass().getResource("/Images/backGrounds/white.png").toExternalForm()));
            pane.getChildren().add(eye1);
            images.add(eye1);
            BackGround eye2 = new BackGround(100, 100, 3970, 320, new Image(getClass().getResource("/Images/backGrounds/white.png").toExternalForm()));
            pane.getChildren().add(eye2);
            images.add(eye2);
            BackGround castle = new BackGround(400, 400, 3900, 200, new Image(getClass().getResource("/Images/backGrounds/castle.png").toExternalForm()));
        ...
        //addBlock
        {
            ...
            for (int i = 0; i <= 5800; i += 30) {
                if ((i >= 340 && i < 630) || (i >= 990 && i < 1110) || (i >= 1170 && i < 1260) || (i >= 1290 && i < 1350) || (i >= 1380 && i < 1440) || (i >= 1740 && i < 2100)) {
        ...
        stage.show();
        @SuppressWarnings("unused") MotionHandler motionHandler = new MotionHandler(blocks, enemies, images, items, stage, pane,7,state);
    }
