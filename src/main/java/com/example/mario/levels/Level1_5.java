...
public class Level1_5 {
    ...
    public Level1_5(int state) throws Exception {
        ...
        //addBackGround
        {
            ...
            images.add(hill2);
            BackGround sign = new BackGround(100, 120, 4730, 410, new Image(getClass().getResource("/Images/backGrounds/sign.png").toExternalForm()));
            pane.getChildren().add(sign);
            images.add(sign);
            BackGround sign2 = new BackGround(120, 100, 5380, 470, new Image(getClass().getResource("/Images/backGrounds/sign2.png").toExternalForm()));
...
//            enemies.add(enemyPipe);
        ...
        stage.show();
        @SuppressWarnings("unused") MotionHandler motionHandler = new MotionHandler(blocks, enemies, images, items, stage, pane, 5, state);
    }
