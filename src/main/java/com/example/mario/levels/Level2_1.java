...
public class Level2_1 {
    ...
    public Level2_1(int state) throws Exception {
        ...
        stage.show();
        @SuppressWarnings("unused") MotionHandler motionHandler = new MotionHandler(blocks, enemies, images, items, stage, pane,6,state);
    }
