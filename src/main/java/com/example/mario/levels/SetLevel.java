...
public class SetLevel {
    ...
    public boolean levelSet() {
        try {
            ...
            if (level == 4) new Level1_5();
            if (level == 5) new Level2_1();
            if (level == 6) new Level2_2();
            if (level == 7) new Level2_3();
    ...
    public void jsonLevelSet() {
        try {
            ...
            if (level == 5) new Level1_5();
            if (level == 6) new Level2_1();
            if (level == 7) new Level2_2();
            if (level == 8) new Level2_3();
        } catch (Exception ignored) {
        }
    }
}
